...
/**
 ...
 @param latitude Optional.  Coordinates according to google definitions: https://support.google.com/maps/answer/18539?co=GENIE.Platform%3DAndroid&hl=en&oco=1
                            The precession (see: http://gis.stackexchange.com/a/8674 ) should be at least 6 points after the decimal point(at least 0.11m).
                            For example, latitude = 24.12345 -> not valid. latitude = 24.123456 -> valid.
                            The latitude must be a number between -90 and 90. For unknown pass -91
 @param longitude Optional. See latitude. The longitude must be a number between -180 and 180. For unknown pass -181
 @param address Optional.   Address for the place you're adding. If this is null, the api will set this up according to the latitude and longitude you've provided.
 @param name Optional.      Name for the place you're adding. If this is null, the api will set this up according to the latitude and longitude you've provided.
                            If the name is empty, and the address is not, the name will be the address.
